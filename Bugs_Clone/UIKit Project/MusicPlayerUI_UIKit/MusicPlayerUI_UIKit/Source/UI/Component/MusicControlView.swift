...
final class MusicControlView: UIView, MusicControlController {
    ...
    // MARK: MusicControlController

    func setPlayPauseControlNextMode(animated: Bool) {
        playPauseControl.setNextMode(animated: animated)
    }
}
